...
class ShimmerButtonView: UIButton {
...
class ShimmerLabelView: UILabel {
...
extension UIView {
    ...
    fileprivate func configureAndStartShimmering() {
        ...
        layer.cornerRadius = UIConstant.radius*3
        startShimmering()
    }
}
...
extension UIView {
    ...
    func startShimmering() {
        ...
        let dark = UIColor.black.withAlphaComponent(0.4).cgColor
